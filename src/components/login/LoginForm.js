...
import FBlogo from '../../css/img/images/fb-logo.png';
...
class LoginForm extends Component {
    ...
    validate = () => {
        ...
        if (!this.state.email) {
            ...
            inputError = true;
            errors.emailError = (
                <span style={{ color: 'red' }}>Your email adress must be valid</span>
            )
        }

        if (this.state.password.length < 4) {
            inputError = true;
            errors.passwordError = 'Tiur password must contain between 4 and 60 charaters';
        }
        this.setState({
            ...errors
        });
                    ...
                    <form>
                        ...
                        <label className="checkbox-container">
                            ...
                            <input type="checkbox"
                                ...
                                onChange={TouchList.handlerCheckbox}
                            />
